...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    // === 8. CHÈN VÀO CSDL (Phần bạn yêu cầu viết tiếp) ===
    $insertSql = "INSERT INTO users (name, email, password, usertype) VALUES (?, ?, ?, 'user')";
    
    try {
        // Chuẩn bị câu lệnh
        $stmt_insert = mysqli_prepare($conn, $insertSql);
        
        // Gán 3 biến (name, email, hashed_password) vào 3 dấu ?
