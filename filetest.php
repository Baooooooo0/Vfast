...
$sql_product = "SELECT * FROM product WHERE product_id = ?";
$stmt_product = $data->prepare($sql_product);
            ...
            <div class="item-content">
                ...
                <div class="items-content">
                    <div>
                        ...
                        <?php else: ?>
                            <button class="details" disabled style="background-color: #ccc;">Hết hàng</button>
                        <?php endif; ?>
                    </div>
                </div>
            </div>
                    ...
                    <form action="payment.php" method="POST" id="buyNowForm">
                        ...
                        <?php if ($user_address): ?>
                            <div class="address-display">
                                ...
                                <a href="address_crud.php" class="btn btn-secondary btn-sm">Chỉnh sửa địa chỉ</a>
                            </div>
                        ...
                        <?php else: ?>
                            ...
                            <a href="address_crud.php" class="btn btn-primary" style="width:100%;">Thêm địa chỉ giao hàng</a>
                        <?php endif; ?>
                        
                        <hr>
                        <h5>Số lượng đặt mua</h5>
                        <div class="form-group">
                            <input type="number" class="form-control" name="quantity" value="1" min="1" max="<?php echo htmlspecialchars($product['product_number']); ?>" required style="padding-left: 10px;">
                        </div>
